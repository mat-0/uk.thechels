...
There is also an export function which opens the share sheet - which then can let the user copy the file into the [Working Copy](https://workingcopy.app) space and commit the file on the go.
