...
I also like some the prompt actions called Skills e.g., /morning gives me a daily rundown of news and weather although this could improve over time. It uses my open tabs first and then broader internet context. For example I ask for a weather update and it fails, yet one of my tabs is my own site with a weather forecast on it.

I have adding /osint <name, location> for a decent fact sheet about people, /tasks for identify things/actions to take from my open tabs (often github issues, news articles of interest)
