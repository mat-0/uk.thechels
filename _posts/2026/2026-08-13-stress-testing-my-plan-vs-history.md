...
So I've plugged in my income, my assets, my planned expenditure from now until retirement and beyond and set an aggressive 48 target compared to [my other post](https://thechels.uk/the-ISA-retirement-bridge) where 50 looks much more comfortable.
...
Here is a high level summary of the data used. It assumes from 2026 until retirement I will contribute a total of £20k into my pension (including employer contributions and tax relief via a salary sacrifice scheme) per year, [£20k in to my S&S ISA per year](https://thechels.uk/what-to-do-when-you-fill-your-ISA) - both in the highest risk global equity fund available.
...
As such I've used the tool on pessimistic mode there is also median and optimistic. Pessimistic is the 30th percentile, median is 50th and optimistic 70th. So by choosing the 30th percentile and a pessimistic approach this should cater for a bad return or [sequencing risk](https://thechels.uk/what-is-sequencing-risk).
